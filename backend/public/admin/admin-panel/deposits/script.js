...
function displayTransactionHistory(transactionHistory) {
    ...
    if (transactionHistory.length === 0) {
        ...
        transactionHistory.forEach(transaction => {
            ...
            listItem.textContent = `Transaction No: ${transaction[0]}, Amount: ${transaction[3]}, Depositing Account: ${transaction[4]}, Date: ${transaction[1]}, Time: ${transaction[2]}, Status: ${transaction[5]}`;
